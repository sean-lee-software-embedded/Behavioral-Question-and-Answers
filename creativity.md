...
- Set up the full platform, pairing button, and a 4K monitor in our office hallway so anyone could experience the PoC; this kept the demo available 24/7 and sparked organic feedback from sales, support, and hardware teams.
...
## Result
The demo ran cleanly in the executive roadshow, earning approval to productize the feature. We also gathered hallway feedback through a quick poll that captured comments from colleagues across Barco’s functional teams, which helped us smooth out UX rough edges before handoff to product.
